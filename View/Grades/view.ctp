...
<div class="related">
	...
	<?php foreach ($grade['Classroom'] as $classroom): ?>
		<tr>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('查看'), array('controller' => 'classrooms', 'action' => 'view', $classroom['id'])); ?>
...
<div class="related">
	...
	<?php foreach ($grade['Student'] as $student): ?>
		<tr>
			...
			<td><?php echo $grade['Grade']['name']; ?></td>
			<td class="actions">
				<?php echo $this->Html->link(__('查看'), array('controller' => 'students', 'action' => 'view', $student['id'])); ?>
