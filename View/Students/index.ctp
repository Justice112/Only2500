...
<?php echo $this->Form->create('Student',array('type'=>'get','url'=>array('controller'=>'students','action'=>'index'))); ?>
	<fieldset>
	<?php
...
<?php echo $this->Form->end(__('确定')); ?>
	...
	<tr>
		...
		<td>
			...
			<td class="actions">
			<?php echo $this->Html->link(__('查看'), array('action' => 'view', $student['Student']['id'])); ?>
