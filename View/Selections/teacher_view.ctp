...
<div class="actions">
	...
	<ul>
		<li><?php //echo $this->Html->link(__('编辑该题'), array('action' => 'TeacherEdit', $selection['Selection']['id'])); ?> </li>
		<li><?php //echo $this->Form->postLink(__('删除该题'), array('action' => 'TeacherDelete', $selection['Selection']['id']), array(), __('您确定要删除 # %s吗?', $selection['Selection']['topic'])); ?> </li>
