...
<?php echo $this->Form->create('Selection'); ?>
	...
	<?php
	 ...
	 <div class="input text">
		...
		<?PHP
		//echo $this->Form->input('picture',array('label'=>'上传图片'));
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('删除该题目'), array('action' => 'delete', $this->Form->value('Selection.id')), array(), __('您确定要删除 # %s吗?', $this->Form->value('Selection.id'))); ?></li>
