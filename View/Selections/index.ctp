<div class="selections index">
	...
	<tr>
		...
		<td><img src="/images/selectionimg/<?php if ($this->data['Selection']['picture']) {echo h($selection['Selection']['picture']);}else {echo "default.jpg";}?>" height="50"></td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('查看'), array('action' => 'view', $selection['Selection']['id'])); ?>
			<?php echo $this->Html->link(__('编辑'), array('action' => 'edit', $selection['Selection']['id'])); ?>
			<?php echo $this->Form->postLink(__('删除'), array('action' => 'delete', $selection['Selection']['id']), array(), __('您确定要删除# %s吗?', $selection['Selection']['topic'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
