<div class="exams index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('考试类型'); ?></th>
			<th><?php echo $this->Paginator->sort('管理老师'); ?></th>
			<th><?php echo $this->Paginator->sort('考试科目'); ?></th>
			<th><?php echo $this->Paginator->sort('考试日期'); ?></th>
			<th><?php echo $this->Paginator->sort('考试时间'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($exam['Exam']['exam_time']); ?>&nbsp;</td>
		<td class="actions">
