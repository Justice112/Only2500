...
<?php echo $this->Form->create('Exam'); ?>
	...
	<?php
		echo $this->Form->input('type',array('label'=>'考试类型','options'=>array('正式考试'=>'正式考试','补考'=>'补考','其他'=>'其他'),'empty'=>'请选择..','default'=>'正式考试'));
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('当前考试信息'), array('action' => 'teacherIndex')); ?></li>
