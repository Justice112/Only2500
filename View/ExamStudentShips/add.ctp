...
<?php echo $this->Form->create('Student',array('type'=>'get','url'=>array('controller'=>'ExamStudentShips','action'=>'add',$this->Session->read('exam_id')))); ?>
	<fieldset>
	<?php
...
<h2><?php echo __('学生列表'); ?></h2>
	<?php echo $this->Form->create('ExamStudentShip',array('url'=>array('controller'=>'ExamStudentShips','action'=>'add',$this->Session->read('exam_id')))); ?>
